    ...
    private static Event extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONObject mainObject = baseJsonResponse.getJSONObject("main");
                ...
                double tempdeg = tempvalue-273.15;
                DecimalFormat numberFormat = new DecimalFormat("#");
                String formattedNumber = numberFormat.format(tempdeg);


            JSONArray maincondition = baseJsonResponse.getJSONArray("weather");
            JSONObject weatherItem = maincondition.getJSONObject(0);
            String mainitem = weatherItem.getString("main");

            JSONObject cloudiness = baseJsonResponse.getJSONObject("clouds");
            String percentcloud = cloudiness.getString("all");

                // Create a new {@link Event} object
                return new Event(formattedNumber, cityName, humidity, mainitem, percentcloud);
